...
.DEFAULT_GOAL := help
.PHONY: unistream help
project := unistream greet calculator blog
...
unistream: $@ ## Generate Pbs and build for unistream
...
clean: clean_unistream ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_unistream: ## Clean generated files for unistream
	${RM_F_CMD} unistream/${PROTO_DIR}/*.pb.go
